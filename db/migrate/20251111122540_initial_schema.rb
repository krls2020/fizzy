class InitialSchema < ActiveRecord::Migration[8.2]
  def change
    create_table "accesses", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "account_join_codes", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
    ...
    create_table "accounts", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.datetime "created_at", null: false
    ...
    create_table "action_text_rich_texts", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "active_storage_attachments", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "active_storage_blobs", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "active_storage_variant_records", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "blob_id", null: false
      t.string "variation_digest", limit: 255, null: false
      t.index ["blob_id", "variation_digest"], name: "index_active_storage_variant_records_uniqueness", unique: true
    end

    create_table "assignees_filters", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "assigners_filters", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "assignments", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "assignee_id", null: false
      t.uuid "assigner_id", null: false
    ...
    create_table "board_publications", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "board_id", null: false
      t.datetime "created_at", null: false
    ...
    create_table "boards", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
    ...
    create_table "boards_filters", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "board_id", null: false
      t.uuid "filter_id", null: false
    ...
    create_table "card_activity_spikes", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "card_id", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    create_table "card_engagements", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "card_id"
      t.datetime "created_at", null: false
    ...
    create_table "card_goldnesses", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "card_id", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    create_table "card_not_nows", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "card_id", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.uuid "user_id"
    ...
    create_table "cards", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.uuid "board_id", null: false
      t.uuid "column_id"
      t.datetime "created_at", null: false
    ...
    create_table "closers_filters", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "closures", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "card_id", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.uuid "user_id"
    ...
    create_table "columns", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.uuid "board_id", null: false
    ...
    create_table "comments", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.uuid "card_id", null: false
      t.datetime "created_at", null: false
      t.uuid "creator_id", null: false
    ...
    create_table "creators_filters", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "creator_id", null: false
      t.uuid "filter_id", null: false
    ...
    create_table "entropies", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "events", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
    ...
    create_table "filters", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.datetime "created_at", null: false
      t.uuid "creator_id", null: false
    ...
    create_table "filters_tags", id: false, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "filter_id", null: false
    ...
    create_table "identities", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.datetime "created_at", null: false
    ...
    create_table "magic_links", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.string "code", limit: 255, null: false
      t.datetime "created_at", null: false
    ...
    create_table "memberships", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.datetime "created_at", null: false
    ...
    create_table "mentions", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.datetime "created_at", null: false
    ...
    create_table "notification_bundles", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.datetime "created_at", null: false
    ...
    create_table "notifications", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.datetime "created_at", null: false
      t.uuid "creator_id"
      t.datetime "read_at"
    ...
    create_table "pins", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "card_id", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.uuid "user_id", null: false
    ...
    create_table "push_subscriptions", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
    ...
    create_table "reactions", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "search_queries", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.datetime "created_at", null: false
    ...
    create_table "search_results", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    end

    create_table "sessions", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.datetime "created_at", null: false
      t.uuid "identity_id", null: false
    ...
    create_table "steps", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.uuid "card_id", null: false
    ...
    create_table "taggings", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "card_id", null: false
      t.datetime "created_at", null: false
      t.uuid "tag_id", null: false
      t.datetime "updated_at", null: false
    ...
    create_table "tags", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.datetime "created_at", null: false
      t.string "title", limit: 255
      t.datetime "updated_at", null: false
    ...
    create_table "user_settings", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "users", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
    ...
    create_table "watches", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "card_id", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.uuid "user_id", null: false
    ...
    create_table "webhook_delinquency_trackers", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
    ...
    create_table "webhook_deliveries", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.datetime "created_at", null: false
    ...
    create_table "webhooks", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_unicode_ci" do |t|
      t.uuid "account_id"
      t.boolean "active", default: true, null: false
      t.uuid "board_id", null: false
      t.datetime "created_at", null: false
